...
<body>
    ...
    if(mysqli_num_rows($query) > 0) {
      while ($rows = mysqli_fetch_assoc($query)) {
        ...
        ?>
            <div
                class="relative flex w-full max-w-[23rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-xl">
                <div
            ...
            if(mysqli_num_rows($query2) > 0) {
              ...
              $photo = $row['p_photo'];
            //   echo '<img class="hover:transition-transform duration-300 hover:transform hover:scale-125 peer" src="owner/'.$photo.'" alt="Property Image">';
              echo '<img class="w-auto h-56" src="owner/'.$photo.'" alt="Property Image">
';
            }
            ?>
                ...
                <div class="p-6">
                    ...
                    <!-- <h5 class="card-title"><b><?php echo $rows['property_type']; ?></b></h5> -->
                    <p class="card-text"><?php echo $rows['city'].', '.$rows['country'] ?></p>
                    <div class="inline-flex flex-wrap items-center gap-3 mt-8 group">
                        <span
                            class="cursor-pointer rounded-full border border-gray-900/5 bg-gray-900/5 p-3 text-gray-900 transition-colors hover:border-gray-900/10 hover:bg-gray-900/10 hover:!opacity-100 group-hover:opacity-70 tooltip"
                            data-tip="CCTV">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="w-4 h-4">
                        ...
                        <span
                            class="cursor-pointer rounded-full border border-gray-900/5 bg-gray-900/5 p-3 text-gray-900 transition-colors hover:border-gray-900/10 hover:bg-gray-900/10 hover:!opacity-100 group-hover:opacity-70  text-[12px]">
                            +20
                        </span>
                    </div>
                </div>
                <div class="p-6 pt-3">
                    <button
                        ...
                        type="button">
                        <?php echo '<a href="view-property.php?property_id='.$rows['property_id'].'" >View Property </a><br>'; ?>
                    </button>
                </div>
            </div>
            <?php 
