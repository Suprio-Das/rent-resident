...
function tenant_register() {
    ...
    $sql = "INSERT INTO tenant (tenant_id, full_name, email, password, phone_no, address, id_type, id_photo)
            VALUES ('$tenant_id', '$full_name', '$email', '$password', '$phone_no', '$address', '$id_type', '$id_photo')";
...
<div class="container">
    <div class="alert">
        ...
        <strong>Incorrect Email/Password or not registered.</strong> Click here to <a href="tenant-register.php"
